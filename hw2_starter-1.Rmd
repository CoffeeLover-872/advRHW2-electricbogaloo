...
***source function:https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/source + review of CI's: https://www.geeksforgeeks.org/how-to-plot-a-confidence-interval-in-r/#*** 

```{r}
devtools::load_all("Rpackage")

dat <- read.csv("Rpackage/data/contraceptive_use-1.csv")
est <- read.csv("Rpackage/data/est-1.csv")
...
```{r}
library(Rd2md)
as_markdown("Rpackage/man/plot_cp.Rd", outfile = "plot_cp.md")
```
...
https://github.com/CoffeeLover-872/advRHW2-electricbogaloo.git